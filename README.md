...
### New
  ...
  - `na_elementsw_backup_s3` - add S3 backup module (`StartBulkVolumeRead` to S3-compatible endpoints) ([issue #1](https://github.com/ansible-collections/netapp.elementsw/issues/1))
