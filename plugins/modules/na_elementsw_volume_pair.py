...
class ElementSWVolumePair(object):
    ...
    def get_account_id(self, account, type):
        ...
        try:
            if type == 'src':
                self.parameters['src_account_id'] = self.elementsw_helper.account_exists(
                    account)
            elif type == 'dest':
                self.parameters['dest_account_id'] = self.dest_elementsw_helper.account_exists(
                    account)
        except solidfire.common.ApiServerError as err:
    ...
    def get_volume_id(self, volume, type):
        ...
        """
        if type == 'src':
            self.parameters['src_vol_id'] = self.elementsw_helper.volume_exists(
            ...
            self.parameters['dest_vol_id'] = self.dest_elementsw_helper.volume_exists(
