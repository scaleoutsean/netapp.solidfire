...
class ElementSWSnapShotSchedule(object):
    ...
    def __init__(self):
        ...
        self.argument_spec.update(dict(
            ...
            schedule_type=dict(required=False, choices=[
                               'DaysOfWeekFrequency', 'DaysOfMonthFrequency', 'TimeIntervalFrequency']),
            ...
            days_of_month_monthdays=dict(
                required=False, type='list', elements='int'),
    ...
    def get_frequency(self):
        ...
        if self.schedule_type is not None and self.schedule_type == 'DaysOfWeekFrequency':
            ...
            if not params or sum(params.values()) == 0:
                self.module.fail_json(
                    msg='Specify at least one non zero value with TimeIntervalFrequency.')
    ...
    def create_schedule(self):
        ...
        try:
            ...
            if frequency is None:
                self.module.fail_json(
                    msg='Failed to create schedule frequency object - type %s parameters' % self.schedule_type)
